# nvim-treesitter-queries-rescript

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-rescript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-rescript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **rescript**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-rescript",
...
- [ ] Changes are scoped to `rescript` — do not include files for other languages
